module github.com/GaukasWang/conjuRTC
...
require (
	...
	github.com/GaukasWang/gotapdance v0.0.0-20220410023717-2db63e969504
...
require (
	github.com/Gaukas/randutil_kai v0.2.0 // indirect
